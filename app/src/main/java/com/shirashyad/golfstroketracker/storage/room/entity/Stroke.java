...
public class Stroke {
    ...
    public int chipShot;
    public int putt;
    public int longMissedShots;

    public Stroke(int id, int gameId, int userId, int longFiarwayShot, int longMissedShot,
                  int penalty, int fairwayBunkerShot, int pitchShot, int greenSideBunkerShot,
                  int chipShot, int putt, int longMissedShots) {
        this.id = id;
        this.gameId = gameId;
        this.userId = userId;
        this.longFiarwayShot = longFiarwayShot;
        ...
        this.putt = putt;
        this.longMissedShots = longMissedShots;
    }
}
